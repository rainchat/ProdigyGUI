        ...
        for (String subSectionName : file.getKeys(false)) {
            ...
            for (String item : section.getKeys(false)) {
                ...
                if (s.isString(MATERIAL)) {
                    itemdata = new ItemData(s.getString(NAME), Material.valueOf(s.getString(MATERIAL).toUpperCase()));
